# Volleyball 6–2 Rotation Guide — v13

GitHub Pages front end + Supabase shared roster.

### v13 changes
- Final serve-receive adjustment: in Rotations 2 and 5, the setter now sits directly on the PASS / SET TARGET.
...
- Supabase LIVE sync settings from v13 are preserved.
...
The header shows **BUILD v13**. If that badge is not visible after publishing, the browser/GitHub page is still serving an older build.
